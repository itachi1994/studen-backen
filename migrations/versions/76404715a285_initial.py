...
Revision ID: 76404715a285
Revises: 
Create Date: 2025-06-27 22:23:20.252138
...
def upgrade():
    ...
    sa.Column('mes_ano', sa.String(length=30), nullable=True),
    ...
    sa.Column('sima_username', sa.String(length=100), nullable=True),
    sa.Column('sima_password', sa.String(length=100), nullable=True),
    sa.PrimaryKeyConstraint('id'),
